...
public class BleManager {
    ...
    private static final int DEFAULT_OPERATE_TIME = 8000;
    private static final int DEFAULT_CONNECT_RETRY_COUNT = 5;
    private static final int DEFAULT_CONNECT_RETRY_INTERVAL = 8000;
    ...
    public BluetoothGatt connect(BleDevice bleDevice, BleGattCallback bleGattCallback) {
        ...
        if (bleDevice == null || bleDevice.getDevice() == null) {
            ...
            //if (bleDevice.getMac() == "E7:7E:9D:6D:8B:8E") {
    ...
    public void indicate(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onIndicateFailure(new OtherException("This device did not connect!"));
        } else {
            bleBluetooth.newBleConnector()
    ...
    public void write(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onWriteFailure(new OtherException("This device is not connected!"));
        } else {
